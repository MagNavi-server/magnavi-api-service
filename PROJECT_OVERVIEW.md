...
| 실내 위치 목록 | `GET /locations/` | 4-1단계 구현, [장소 API 안내](docs/api/PLACE_API.md) |
| 실내 위치 상세 | `GET /locations/{location_id}` | 4-1단계 구현. ID는 새 DB의 내부 장소 ID |
